...
$(document).ready(function () {
    Vue.component('vue-select', {
        template: '<select v-bind:class="class" v-model="model" v-bind:multiple="multiple" v-bind:size="size" v-bind:name="name" v-bind:id="id" v-bind:disabled="disabled" v-on:change="changes">' +
