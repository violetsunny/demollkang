...
<html>
	...
	<body style="font-family: SimSun;line-height:1">
		<div style="width:100%;">
			...
			<div style="background:url(http://home.tcent.cn/images/logo208.png);background-repeat: no-repeat;background-position: center;background-position:top;width:250px;height:250px;margin-right: 10px;margin-top: 100px;float: right;padding-top: 150px;padding-left: 100px;padding-right: 10px">
