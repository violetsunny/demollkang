  ...
  <div class="container" style="width:100%;">
   ...
   <div class="cont-title" style="padding:0px 0px;border-top: 2px solid #7591a7;text-align:center;font-size:20px;font-weight:bold;color:#333;">
      ...
      <div style="padding:0px;background-color:#f9f9f9;font-size:10px;">
          <p style="margin:10px 0px 0px;"><span style="color:#666;">客户：</span><span style="color:#333;">${oppsiteCompanyName}</span></p>
      </div>
   <div style="padding:0px;background-color:#f9f9f9;font-size:10px;">
    ...
    <#list certificates as certificate>
       <p style="margin:10px 0px 0px;"><span style="color:#666;">${certificate.certificateType}：</span><span style="color:#333;">${certificate.certificateCode}</span></p>
    </#list>
   </div>
   <#if  showFlight == "1">
   <#list flights as flight>
   <div class="product-cont" style="margin-top:0px;padding-bottom: 18px;font-size:10px;background-color:#f9f9f9;">
    <p style="position:relative;padding: 6px 0px 6px 48px;margin:0px;background-size: auto 14px;background-color:#e5f1f8;color:#666;"><img src="./card_plane.png" style="position:absolute;top:0px;left:0px;height: 20px;">
        国内机票
        <span  class="font-w">  &nbsp;订单号：${flight.orderNo}</span>
    </p>
    ...
    <#list flight.segmentDataVOs as segment>
     ...
     <div class="flight-info">
      ...
      <div style="margin-left:8px;">
       <p style="margin:10px 0px 0px;"> <span style="display: inline-block;width: 30px;color:#666;">票号：</span><span style="color:#333;">${flight.ticketNo}</span>&#xa0; <span style="margin-left:20px;color:#333;">客票有效期：${flight.effecticeTime}年</span><#if  showTicketCode == "true">&#xa0;</#if> </p>
     </div>
    </div>
   ...
   <div style="">
      <div style="wrapper">
          <p>开具方：北京同程华鼎国际旅行社有限公司</p>
          <p>开具日期：${createTime}</p>
          <img style="" src="./huading_chapter.png" />
      </div>
  </div>
 </body>
</html>